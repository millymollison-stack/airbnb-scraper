...
export function FontDropdown({ value, options, onChange }: FontDropdownProps) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && triggerRect && (
        <div
          className="fixed bg-white border border-gray-200 rounded-lg shadow-lg z-[99999] max-h-56 overflow-y-auto"
          style={{
