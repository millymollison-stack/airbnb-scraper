      ...
      return {
        ...
        html: `
          ...
          <div style="margin: 30px 0;">
            <a href="${paymentLink}" style="background-color: [var(--brand)]; color: white; padding: 15px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">
