    ...
    <div className="space-y-6">
      <div className="flex justify-center pt-6">
        <select
          ...
          className="w-48 text-base border-gray-300 rounded-md shadow-sm focus:ring-[var(--brand)] focus:border-[var(--brand)]"
        >
              ...
              <div>
                <div className="mt-3 text-center sm:mt-5">
                  ...
                  <div className="mt-2">
                    <textarea
                      rows={4}
                      className="shadow-sm focus:ring-[var(--brand)] focus:border-[var(--brand)] block w-full sm:text-sm border-gray-300 rounded-md"
