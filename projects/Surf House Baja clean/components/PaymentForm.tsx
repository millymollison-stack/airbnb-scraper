    ...
    return (
      <div className="bg-white p-6 rounded-lg shadow">
        ...
        <button
          ...
          className="w-full flex justify-center items-center space-x-2 px-4 py-3 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[var(--brand)] hover:bg-[var(--brand-hover)] focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[var(--brand)] disabled:bg-[var(--brand-disabled)] disabled:cursor-not-allowed"
        >
          {loading ? (
            <>
