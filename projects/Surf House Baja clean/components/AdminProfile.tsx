          ...
          <div className="space-y-4">
            <div>
              ...
              <input
                ...
                disabled={!isEditing}
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-[var(--brand)] focus:ring-[var(--brand)] disabled:bg-gray-50 disabled:text-gray-500"
              />
            </div>
